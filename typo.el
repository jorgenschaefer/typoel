;;; typo.el --- Minor mode to enable typographic editing
...
;; `typo-mode' is a buffer-specific minor mode that will change a
;; number of normal keys to make them insert typographically useful
;; unicode characters. Some of those keys can be used repeatedly to
;; cycle through variations. This includes in particular quotation
;; marks and dashes.
...
;; This file was created based on my own idea and motivation. After it
;; was written, I came across typopunct.el, which supports similar
;; goals. I got some ideas from there.
...
;; Unicode supports ligatures (ff, fi, fl, ffi, ffl). This is nice,
;; but quite a lot of fonts lack support for this. Also, it could be
;; argued that ligatures should happen as part of the display process,
;; not in the document. Use ZERO WIDTH NON-JOINER (C-c 8 SPC SPC SPC)
;; to prevent two characters from being merged like this.
